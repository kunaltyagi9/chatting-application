...
public class Client implements ActionListener
{
    ...
    //Send for Data output to the Server
    ...
    Client()
    {
        ...
        // For Profile Photo
        ImageIcon icon4 = new  ImageIcon(ClassLoader.getSystemResource("icons/1.png"));
        ...
        //Main Title Set Client Side
        JLabel title = new JLabel("Client-Side");
        title.setBounds(197,50,100,15);
        title.setForeground(new Color(229, 229, 237));
        title.setFont(new Font("SAN SERIF",Font.CENTER_BASELINE,17));

        //Profile Name set
        JLabel name = new JLabel("Server Assistant");
        name.setBounds(95,19,150,18);
    ...
    public void actionPerformed(ActionEvent event)
    {
        try
        {
            ...
            //Vertical Show Your Message from at the Page End Means Inner Message Panel.
            p2.add(vertical, BorderLayout.PAGE_START); // p2 is Main Panel

            //Client Send the Message to Server using write-UTF, Message Pass in outputStream object
...
public static void main(String args[])
    {
        new Client(); // This is Anonymous Class
        try
        {
            ...
            while (true)
            {
                ...
                p2.setLayout(new BorderLayout());   // Border Layout for Right hand side
